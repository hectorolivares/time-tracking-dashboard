  ...
  return (
    <>
      ...
      <section
        ...
        className="rounded-tl-[20px] rounded-tr-[20px] rounded-br-[50px] rounded-bl-[50px] font-light relative w-full max-w-[600px] min-h-[210px] desktop:h-full"
      >
        ...
        <div className="bg-[#1D204B] hover:bg-[#34397B] duration-300 ease-out text-white rounded-[20px] p-7 absolute bottom-0 right-0 w-full cursor-pointer">
          <div className="flex justify-between mb-8 laptop:mb-2 desktop:mb-8">
            <h4 className="text-xl laptop:text-lg">{id}</h4>
            <button className="opacity-60 text-2xl hover:opacity-100 transition duration-300 ease-out">
              <ion-icon name="ellipsis-horizontal"></ion-icon>
            </button>
          </div>
          <div className="flex justify-between laptop:flex-col desktop:flex-col ">
